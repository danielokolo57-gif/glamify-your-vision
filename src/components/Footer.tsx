...
export function Footer() {
  return (
    <footer className="bg-sage-dark text-cream/85 mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="font-display text-5xl text-cream leading-none">sage</div>
          <p className="mt-4 max-w-sm text-sm text-cream/70 leading-relaxed">
            Conscious simplicity for skin & hair. Thoughtful ingredients, soft textures,
            and a calm, minimal approach to everyday care.
          </p>
        </div>
