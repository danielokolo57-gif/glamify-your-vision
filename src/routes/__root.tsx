...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Belletny — Premium beauty & skincare in Nigeria" },
      {
        name: "description",
        content:
          "Belletny is Nigeria's home for premium cosmetics, skincare and fragrance. Shop curated formulas with delivery across Lagos, Abuja, Port Harcourt and nationwide.",
      },
      { name: "author", content: "Belletny" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:title", content: "Belletny — Premium beauty & skincare in Nigeria" },
      { name: "twitter:title", content: "Belletny — Premium beauty & skincare in Nigeria" },
